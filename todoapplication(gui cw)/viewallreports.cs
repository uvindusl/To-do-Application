...
{
    public partial class viewallreports : MetroSetForm
    {
        ...
        private void viewallreports_Load(object sender, EventArgs e)
        {
            loadDataToTable();
        }
        ...
        {
            alltaskreport alltaskreport = new alltaskreport();
            alltaskreport.Show();
